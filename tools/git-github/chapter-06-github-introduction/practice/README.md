...
Use this practice set to turn the Github Introduction lesson into hands-on repetition instead of passive reading.
...
Start with a small Git and GitHub task connected to github introduction. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of github introduction in my own words.
