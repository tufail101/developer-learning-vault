...
Use this practice set to turn the Components Props lesson into hands-on repetition instead of passive reading.
...
Start with a small React task connected to components props. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of components props in my own words.
