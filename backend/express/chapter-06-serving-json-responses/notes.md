...
Most APIs return JSON. Express makes it easy to send arrays and objects with `res.json()`.

## Real-World Analogy

JSON is like sending data in labeled boxes instead of one long sentence. The client can unpack it more easily.
...
Next chapter: **Request And Response Objects**.
