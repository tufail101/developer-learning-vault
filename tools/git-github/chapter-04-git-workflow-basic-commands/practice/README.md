...
Use this practice set to turn the Git Workflow Basic Commands lesson into hands-on repetition instead of passive reading.
...
Start with a small Git and GitHub task connected to git workflow basic commands. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of git workflow basic commands in my own words.
