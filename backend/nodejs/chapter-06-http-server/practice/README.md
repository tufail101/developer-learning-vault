...
Use this practice set to turn the Http Server lesson into hands-on repetition instead of passive reading.
...
Start with a small Node.js task connected to http server. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of http server in my own words.
