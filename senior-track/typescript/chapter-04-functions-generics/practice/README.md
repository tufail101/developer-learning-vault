...
Use this practice set to turn the Functions Generics lesson into hands-on repetition instead of passive reading.
...
Start with a small TypeScript task connected to functions generics. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of functions generics in my own words.
