...
Use this practice set to turn the Validation Responsive Images lesson into hands-on repetition instead of passive reading.
...
Start with a small HTML task connected to validation responsive images. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of validation responsive images in my own words.
