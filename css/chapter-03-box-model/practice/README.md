...
Use this practice set to turn the Box Model lesson into hands-on repetition instead of passive reading.
...
Start with a small CSS task connected to box model. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of box model in my own words.
