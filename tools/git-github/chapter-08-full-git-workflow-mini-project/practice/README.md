...
Use this practice set to turn the Full Git Workflow Mini Project lesson into hands-on repetition instead of passive reading.
...
Start with a small Git and GitHub task connected to full git workflow mini project. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of full git workflow mini project in my own words.
