...
Use this practice set to turn the Layout Flexbox Grid lesson into hands-on repetition instead of passive reading.
...
Start with a small CSS task connected to layout flexbox grid. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of layout flexbox grid in my own words.
