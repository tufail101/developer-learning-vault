...
Use this practice set to turn the tsconfig And Tooling lesson into hands-on repetition instead of passive reading.
...
Start with a small TypeScript task connected to tsconfig and tooling. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of tsconfig and tooling in my own words.
