...
Use this practice set to turn the Dom Introduction Selecting Elements lesson into hands-on repetition instead of passive reading.
...
Start with a small JavaScript task connected to dom introduction selecting elements. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of dom introduction selecting elements in my own words.
