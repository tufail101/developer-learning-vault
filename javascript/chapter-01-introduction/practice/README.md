...
Use this practice set to turn the Introduction lesson into hands-on repetition instead of passive reading.
...
Start with a small JavaScript task connected to introduction. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of introduction in my own words.
