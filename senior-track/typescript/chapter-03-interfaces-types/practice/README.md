...
Use this practice set to turn the Interfaces Types lesson into hands-on repetition instead of passive reading.
...
Start with a small TypeScript task connected to interfaces types. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of interfaces types in my own words.
