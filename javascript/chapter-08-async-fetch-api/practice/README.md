...
Use this practice set to turn the Async Fetch Api lesson into hands-on repetition instead of passive reading.
...
Start with a small JavaScript task connected to async fetch api. Keep it simple enough to finish in 10 to 15 minutes.
...
- I can explain the main idea of async fetch api in my own words.
